...
int LoadDictionary(wchar_t* filename) {
	{
		// открыть файл
		FILE* fin = wfopen(filename, L"rt");
		if (fin == NULL) {
...
wchar_t filenameDict[] = L"c:\\Users\\socea\\source\\repos\\LAB26\\Lab_rabota_26\\Dictionaries\\dict0.txt";
